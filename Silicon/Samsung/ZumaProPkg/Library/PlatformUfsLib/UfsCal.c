...
/*
 * ===========================================================================
 *  Zuma (Tensor G4) calibration tables.
 *
 *  PMA COMN/TRSV values are translated from the mainline Linux
 *  phy-gs101-ufs.c "tensor_zuma_pre_init_cfg" / pre/post HS configs.
 *  The mainline tables use PHY register indices; the APB byte address is
 *  (index << 2)  (PHY_APB_ADDR).  Lane stride is 0x800 bytes (0x200 << 2),
 *  handled by PHY_PMA_TRSV_ADDR in the engine.
 *
 *  The UniPro/PCS prologue is kept from the S5E9830 (Exynos 990) template:
 *  these are standard UniPro MIB attributes + PCS period settings (the
 *  period values auto-scale to zuma's MCLK via UNIPRO_MCLK_PERIOD).  These
 *  may need tuning once link-up is observed on hardware.
 * ===========================================================================
 */
static const struct UfsCalPhyCfg init_cfg_zuma[] = {
  /* ---- UniPro / PCS prologue (standard) ---- */
  {0x44,   0x00,        PMD_ALL, UNIPRO_DBG_PRD,           BRD_ALL},
  {0x200,  0x40,        PMD_ALL, PHY_PCS_COMN,             BRD_ALL},
  {0x12,   0x00,        PMD_ALL, PHY_PCS_RX_PRD_ROUND_OFF, BRD_ALL},
  {0xAA,   0x00,        PMD_ALL, PHY_PCS_TX_PRD_ROUND_OFF, BRD_ALL},
  ...
  /* ---- enable PMA APB access ---- */
  {0xA006, 0x80000000,  PMD_ALL, UNIPRO_DBG_MIB,           BRD_ALL},

  /* ---- zuma PMA COMN (phy-gs101-ufs.c tensor_zuma_pre_init_cfg) ---- */
  {0x140,  0x08,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // COMN 0x50
  {0x014,  0x19,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x05
  {0x02C,  0x44,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x0b
  {0x030,  0xC4,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x0c
  {0x034,  0xC3,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x0d
  {0x03C,  0x88,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x0f
  {0x058,  0x1A,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x16
  {0x064,  0x04,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x19
  {0x150,  0x88,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x54
  {0x19C,  0x4C,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x67
  {0x1A0,  0x4C,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x68

  /* ---- zuma PMA TRSV ---- */
  {0x804,  0x44,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // TRSV 0x201
  {0x808,  0x44,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x202
  {0x80C,  0x00,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x203
  {0x810,  0x18,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x204
  {0x814,  0xC0,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x205
  {0x81C,  0x1C,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x207
  {0xBB0,  0x8C,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x2ec
  {0x9F0,  0xD0,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x27c
  {0xA20,  0xFA,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x288
  {0xA24,  0x60,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x289
  {0x8D0,  0x30,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x234
  {0x8E4,  0x05,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x239
  {0x8F4,  0x05,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x23d
  {0x934,  0x1A,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x24d
  {0x938,  0x12,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x24e
  {0x93C,  0x5E,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x24f
  {0x964,  0x2A,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x259
  {0x980,  0x54,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x260
  {0x998,  0x54,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x266
  {0x9CC,  0x00,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x273
  {0x9D0,  0x00,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x274
  {0xAAC,  0x00,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x2ab
  {0xAB0,  0x02,        PMD_ALL, PHY_PMA_TRSV,             BRD_ALL}, // 0x2ac

  /* ---- COMN trigger ---- */
  {0x140,  0x0C,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x50
  {0x140,  0x00,        PMD_ALL, PHY_PMA_COMN,             BRD_ALL}, // 0x50

  /* ---- wait for RX cal done (TRSV 0x338 -> APB 0xCE0, bit3 set) ---- */
  {0xCE0,  0x08,        PMD_ALL, PHY_EMB_CAL_WAIT,         BRD_ALL},

  /* ---- disable PMA APB access ---- */
  {0xA006, 0x00,        PMD_ALL, UNIPRO_DBG_MIB,           BRD_ALL},
  {0, 0, 0, 0, 0},
};

/* PrePmc (HS): tensor_gs101_pre_pwr_hs_config (PHY idx<<2) */
static const struct UfsCalPhyCfg calib_of_hs_zuma[] = {
  {0xDA4,  0x11,        PMD_HS,  PHY_PMA_TRSV,             BRD_ALL}, // TRSV 0x369
  {0x918,  0x03,        PMD_HS,  PHY_PMA_TRSV,             BRD_ALL}, // TRSV 0x246
  {0, 0, 0, 0, 0},
};

/* PostPmc (HS): tensor_gs101_post_pwr_hs_config (PWR_MODE_ANY entries) */
static const struct UfsCalPhyCfg post_calib_of_hs_zuma[] = {
  {0x918,  0x01,        PMD_HS,  PHY_PMA_TRSV,             BRD_ALL}, // TRSV 0x246
  {0, 0, 0, 0, 0},
};
...
{
  /*
   * Zuma RX calibration done: TRSV 0x338 (APB 0xCE0) bit3 is SET when
   * calibration completes (see Linux zuma_phy_wait_for_calibration).
   * Poll up to ~200 ms.
   */
  UINT32 i;
  for (i = 0; i < 200000; i++) {
  ...
  DEBUG ((EFI_D_ERROR, "UFS CAL: RX cal-done timeout lane %d\n", lane));
  return UFS_CAL_ERROR;
}
...
UfsCalError UfsCalPrePmc (struct UfsCalParam *p)
{
  ...
  if ((p->Pmd->Mode == SLOW_MODE) || (p->Pmd->Mode == SLOWAUTO_MODE))
    ...
    cfg = calib_of_hs_zuma;   /* zuma: same pre-HS cfg for series A/B */
...
UfsCalError UfsCalPostPmc (struct UfsCalParam *p)
{
  ...
  if ((p->Pmd->Mode == SLOWAUTO_MODE) || (p->Pmd->Mode == SLOW_MODE))
    ...
    cfg = post_calib_of_hs_zuma;   /* zuma: same post-HS cfg for series A/B */
...
UfsCalError UfsCalPreLink (struct UfsCalParam *p)
{
  ...
  if (p->Table == HOST_CARD) {
    ...
    /* Zuma uses a single calibration table regardless of EVT revision. */
    cfg = init_cfg_zuma;
  }
